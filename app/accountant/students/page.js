                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="bg-gray-50 p-3 rounded">
                      ...
                      <p className="font-medium">Rs.{selectedStudent.tutionFee?.toLocaleString()}</p>
                    </div>
                    <div className="bg-gray-50 p-3 rounded">
                      <span className="text-sm text-gray-600">Labs Fee</span>
                      <p className="font-medium">Rs.{selectedStudent.labsFee?.toLocaleString()}</p>
                    </div>
                    <div className="bg-gray-50 p-3 rounded">
                      <span className="text-sm text-gray-600">Late Fee Fine</span>
                      <p className="font-medium">Rs.{selectedStudent.lateFeeFine?.toLocaleString()}</p>
                    </div>
                    <div className="bg-gray-50 p-3 rounded">
                      <span className="text-sm text-gray-600">Extra Fee</span>
                      <p className="font-medium">Rs.{selectedStudent.extraFee?.toLocaleString()}</p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="space-y-3">
                    <div className="bg-gray-50 p-3 rounded">
                      <div className="flex justify-between">
                        ...
                        <div className="text-right">
                          <p className="font-medium">Rs.{selectedStudent.examFeeTotal?.toLocaleString()}</p>
                          <p className="text-xs text-gray-500">Paid: Rs.{selectedStudent.examFeeCurrentPaid?.toLocaleString()}</p>
                        </div>
                      </div>
                    </div>
                    <div className="bg-gray-50 p-3 rounded">
                      <div className="flex justify-between">
                        ...
                        <div className="text-right">
                          <p className="font-medium">Rs.{selectedStudent.karateFeeTotal?.toLocaleString()}</p>
                          <p className="text-xs text-gray-500">Paid: Rs.{selectedStudent.karateFeeCurrentPaid?.toLocaleString()}</p>
                        </div>
                      </div>
                    </div>
                    <div className="bg-gray-50 p-3 rounded">
                      <div className="flex justify-between">
                        ...
                        <div className="text-right">
                          <p className="font-medium">Rs.{selectedStudent.admissionFeeTotal?.toLocaleString()}</p>
                          <p className="text-xs text-gray-500">Paid: Rs.{selectedStudent.admissionFeeCurrentPaid?.toLocaleString()}</p>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div className="bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-lg p-6">
                <div className="grid grid-cols-3 gap-4">
                  <div>
                    ...
                    <p className="text-2xl font-bold">Rs.{selectedStudent.allTotal?.toLocaleString()}</p>
                  </div>
                  <div>
                    <span className="text-sm opacity-90">Amount Paid</span>
                    <p className="text-2xl font-bold">Rs.{selectedStudent.feePaid?.toLocaleString()}</p>
                  </div>
                  <div>
                    ...
                    <p className={`text-2xl font-bold ${selectedStudent.curBalance > 0 ? 'text-red-200' : 'text-green-200'}`}>
                      Rs.{selectedStudent.curBalance?.toLocaleString()}
                    </p>
                  </div>
                </div>
              </div>
